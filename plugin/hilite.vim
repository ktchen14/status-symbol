...
call <SID>hi('StatusSymbolBuffedActive',              0x04, 0x01, '')
call <SID>hi('StatusSymbolBuffedActiveModifiedMark',  0x0B, 0x01, '')
call <SID>hi('StatusSymbolBuffedActiveReadonlyMark',  0x04, 0x01, '')
call <SID>hi('StatusSymbolBuffedHidden',              0x03, 0x01, '')
call <SID>hi('StatusSymbolBuffedHiddenModifiedMark',  0x0B, 0x01, '')
call <SID>hi('StatusSymbolBuffedHiddenReadonlyMark',  0x03, 0x01, '')
call <SID>hi('StatusSymbolBuffedNormal',              0x03, 0x01, '')
